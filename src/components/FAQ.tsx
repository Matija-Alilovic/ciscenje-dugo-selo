    ...
    <div className="card-modern divide-y divide-gray-200 overflow-hidden">
      {FAQ_ITEMS.map((item) => (
        <details key={item.question} className="group">
          <summary className="cursor-pointer list-none px-4 py-4 text-lg font-medium text-gray-900 transition-colors duration-200 hover:bg-brand-50/50 sm:px-6 sm:text-xl [&::-webkit-details-marker]:hidden">
          ...
          <div className="faq-body">
            <div>
              <p className="px-4 pb-4 text-lg leading-relaxed text-gray-600 sm:px-6">
                {item.answer}
              </p>
            </div>
          </div>
