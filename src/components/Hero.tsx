  ...
  return (
    <section id="hero" className="mesh-bg">
      <div className="mx-auto max-w-6xl px-4 py-14 sm:px-6 sm:py-24 lg:px-8">
        <h1 className="hero-fade hero-delay-1 group w-full min-w-0 max-w-4xl text-3xl font-bold leading-tight text-balance text-gray-900 sm:text-5xl lg:text-6xl">
          <LetterHoverText text={title} delayStepMs={32} />
        </h1>
        <p className="hero-fade hero-delay-2 mt-4 max-w-3xl text-base leading-relaxed text-gray-600 sm:mt-6 sm:text-2xl md:text-[1.65rem]">
          {subtitle}
        </p>
